...
function myFunction() {
	var element = document.getElementById("areaparaocultar");
	element.classList.toggle("menuoculta");
 }
 
 function myFunction2() {
	var element = document.getElementById("areaparaocultar");
	element.classList.toggle("menuoculta2");
 }

//Script para buscar datos en una tabla con id="main-table"


 var busqueda = document.getElementById('buscar');
 var table = document.getElementById("main-table").tBodies[0];
